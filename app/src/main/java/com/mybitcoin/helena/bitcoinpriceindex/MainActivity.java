...
public class MainActivity extends AppCompatActivity implements SeekBar.OnSeekBarChangeListener,
        OnChartGestureListener, OnChartValueSelectedListener, NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        */;
        ...
        new HistoryAsyncTask(MainActivity.this).execute();
...
//        mChart.centerViewTo(20, 50, AxisDependency.LEFT);
        ...
        mChart.animateX(500, Easing.EasingOption.EaseInCirc);
        //mChart.invalidate();
    ...
    private void setData(int count, float range) {
        ...
        for(int i=6;i>=0;i--){
            ...
            values.add(new Entry(time, average));
        }
        ...
        if (mChart.getData() != null &&
            ...
            set1.setValueFormatter(new MyValueFormater());
